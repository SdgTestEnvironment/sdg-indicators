    ...
    if (table && tableHasData(table)) {
        ...
        table.data.forEach(function (data) {
            ...
            table.headings.forEach(function (heading, index) {
                ...
                var dateForTable = (data[index] == 0 && obsValue.indexOf('‒') > 0) ? ('‒' + obsValue.replace('‒','').replace('[]','')) : (data[index] + ' ' + obsValueTable);
                var dateForTable = (data[index] == 0 && obsValue.indexOf('0') > 0) ? ('0' + obsValue.replace('‒','').replace('[]','')) : (data[index] + ' ' + obsValueTable);
                ...
                row_html += cell_prefix + (isYear ? '' : ' class="table-value"') + '>' + (data[index] !== null && data[index] !== undefined ?  dateForTable : obsValueTable) + cell_suffix;
