...
var mapView = function () {
  ...
  this.initialise = function(geoData, geoCodeRegEx) {
    ...
    $('#map').sdgMap({
      ...
      mapOptions: {"tileURL":"https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?mapbox://styles/mobosse/cjzmrn62k0ek11cmgea7a1i1h&access_token={accessToken}","tileOptions":{"id":"mapbox.light","accessToken":"pk.eyJ1IjoibW9ib3NzZSIsImEiOiJjanplNTNhMmQwMTFjM21wNHEzazRlejhwIn0.ecHE5G83cklfW5AXYjI_0A","attribution":"<a href=\"https://www.mapbox.com\">Mapbox</a>"},"colorRange":"chroma.brewer.BuGn","noValueColor":"#f0f0f0"},
