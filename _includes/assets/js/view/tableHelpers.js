    ...
    if (table && tableHasData(table)) {
        ...
        table.data.forEach(function (data) {
            ...
            table.headings.forEach(function (heading, index) {
                ...
                var dateForTable = (data[index] == 0 && obsValue.indexOf('‒') > 0) ? ('‒' + obsValue.replace('‒','')) : (data[index] + ' ' + obsValueTable);
                var dateForTable = (data[index] == 0 && obsValue.indexOf('0') > 0) ? ('0' + obsValue.replace('0','')) : (data[index] + ' ' + obsValueTable);
